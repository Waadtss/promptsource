...
_TRAIN_URL = "C:\\Users\\aalmazrua\\Documents\\مؤشر النضج\\dataset\\reverse_dictionary.csv"


class ReverseDictionary(datasets.GeneratorBasedBuilder):
