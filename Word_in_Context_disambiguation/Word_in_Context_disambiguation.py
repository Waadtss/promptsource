...
_TRAIN_URL = "C:\\Users\\aalmazrua\\Documents\\مؤشر النضج\\dataset\\Word-in-Context-disambiguation.csv"


class WordInContextDisambiguation(datasets.GeneratorBasedBuilder):
            ...
            features=datasets.Features(
                {
                    ...
                    "defention": datasets.Value("string"),
