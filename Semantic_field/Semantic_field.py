...
_TRAIN_URL = "C:\\Users\\aalmazrua\\Documents\\مؤشر النضج\\dataset\\Semantic_field.csv"


class SemanticField(datasets.GeneratorBasedBuilder):
            ...
            features=datasets.Features(
                {
                    ...
                    "semanticField": datasets.Value("string"),
